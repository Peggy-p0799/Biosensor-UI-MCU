...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PC3     ------> ADC2_IN13
    */
    GPIO_InitStruct.Pin = Qsensor_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /* USER CODE END ADC3_MspInit 0 */
    ...
    PF6     ------> ADC3_IN4
    */
    GPIO_InitStruct.Pin = Tsensor_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC1     ------> ADC1_IN11
    */
    HAL_GPIO_DeInit(Psensor_GPIO_Port, Psensor_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC3     ------> ADC2_IN13
    */
    HAL_GPIO_DeInit(Qsensor_GPIO_Port, Qsensor_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PF6     ------> ADC3_IN4
    */
    HAL_GPIO_DeInit(Tsensor_GPIO_Port, Tsensor_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = EN_LSA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(EN_LSA_GPIO_Port, &GPIO_InitStruct);
